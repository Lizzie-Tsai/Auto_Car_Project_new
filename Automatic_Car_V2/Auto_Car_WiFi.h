#ifndef _AUTO_CAR_WIFI_H
#define _AUTO_CAR_WIFI_H
...
#define CMD_UPDATES         "CMD_UPDATES"         //Updates control command
...
#define CMD_OVERRIDE        "CMD_OVERRIDE"       //Control panel override
